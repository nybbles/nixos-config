...

{
  ...
  # Enable Wayland and desktop environment (GNOME with Wayland)
  services.xserver = {
    enable = true;
    displayManager.gdm = {
      enable = true;
  ...
  # Ensure Wayland is used by default
  ...
  # Power management (power-profiles-daemon is recommended for AMD Framework)
